#####code by https://github.com/gidariss/FeatureLearningRotNet#####
#####modified by JingQian
...
_Custom_DATASET_DIR = '/scratch/jq689/deeplearning/student_data/data/scene_104'
...
class GenericDataset(data.Dataset):
    def __init__(self, dataset_name, split, random_sized_crop=False,
        ...
        if self.dataset_name=='imagenet':
            ...
            split_data_dir = _Custom_DATASET_DIR
